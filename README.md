...
If not set, the API uses default values (e.g. 33°C, 60% humidity, 800 mm rainfall). Use a `.env` file in `backend/` with `OPENWEATHER_API_KEY=your_key` (see `.env.example`).
